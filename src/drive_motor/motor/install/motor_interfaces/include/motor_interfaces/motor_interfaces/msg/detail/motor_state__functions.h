...
#ifndef MOTOR_INTERFACES__MSG__DETAIL__MOTOR_STATE__FUNCTIONS_H_
#define MOTOR_INTERFACES__MSG__DETAIL__MOTOR_STATE__FUNCTIONS_H_
 ...
 * calls
 * motor_interfaces__msg__MotorState__init().
...
/**
 * It calls
 * motor_interfaces__msg__MotorState__fini()
 ...
 * motor_interfaces__msg__MotorState__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * motor_interfaces__msg__MotorState__Sequence__fini()
 * on the array,
...
#endif  // MOTOR_INTERFACES__MSG__DETAIL__MOTOR_STATE__FUNCTIONS_H_
