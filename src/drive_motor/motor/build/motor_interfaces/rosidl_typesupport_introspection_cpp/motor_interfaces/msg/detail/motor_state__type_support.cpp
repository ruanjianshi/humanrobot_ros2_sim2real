...
{
  new (message_memory) motor_interfaces::msg::MotorState(_init);
}

void MotorState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<motor_interfaces::msg::MotorState *>(message_memory);
...
void resize_function__MotorState__position(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<float> *>(untyped_member);
  member->resize(size);
...
void resize_function__MotorState__velocity(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<float> *>(untyped_member);
  member->resize(size);
...
size_t size_function__MotorState__torque(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<float> *>(untyped_member);
  return member->size();
}

const void * get_const_function__MotorState__torque(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<float> *>(untyped_member);
  return &member[index];
...
void * get_function__MotorState__torque(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<float> *>(untyped_member);
  return &member[index];
...
void fetch_function__MotorState__torque(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__MotorState__torque(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__MotorState__torque(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__MotorState__torque(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}

void resize_function__MotorState__torque(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<float> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MotorState_message_member_array[3] = {
  {
    "position",  // name
    ...
    offsetof(motor_interfaces::msg::MotorState, position),  // bytes offset in struct
    ...
    resize_function__MotorState__position  // resize(index) function pointer
  },
  {
    "velocity",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_FLOAT,  // type
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(motor_interfaces::msg::MotorState, velocity),  // bytes offset in struct
    nullptr,  // default value
    ...
    resize_function__MotorState__velocity  // resize(index) function pointer
  },
  {
    "torque",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_FLOAT,  // type
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(motor_interfaces::msg::MotorState, torque),  // bytes offset in struct
    nullptr,  // default value
    size_function__MotorState__torque,  // size() function pointer
    get_const_function__MotorState__torque,  // get_const(index) function pointer
    get_function__MotorState__torque,  // get(index) function pointer
    fetch_function__MotorState__torque,  // fetch(index, &value) function pointer
    assign_function__MotorState__torque,  // assign(index, value) function pointer
    resize_function__MotorState__torque  // resize(index) function pointer
  }
};
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MotorState_message_members = {
  ...
  3,  // number of fields
  sizeof(motor_interfaces::msg::MotorState),
...
{
  return &::motor_interfaces::msg::rosidl_typesupport_introspection_cpp::MotorState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, motor_interfaces, msg, MotorState)() {
  return &::motor_interfaces::msg::rosidl_typesupport_introspection_cpp::MotorState_message_type_support_handle;
}
