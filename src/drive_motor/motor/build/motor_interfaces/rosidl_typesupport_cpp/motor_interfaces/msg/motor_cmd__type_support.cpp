...
static const _MotorCmd_type_support_symbol_names_t _MotorCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motor_interfaces, msg, MotorCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, motor_interfaces, msg, MotorCmd)),
  }
};
...
{
  return &::motor_interfaces::msg::rosidl_typesupport_cpp::MotorCmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, motor_interfaces, msg, MotorCmd)() {
  return get_message_type_support_handle<motor_interfaces::msg::MotorCmd>();
}
